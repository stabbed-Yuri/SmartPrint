...
public class WebController {
    ...
    //     
    //     // Get unique locations for the location filter - ensure it's never null
    ...
    //     
    //     // Log for debugging
    //     logger.info("Index page - Total printers: {}, Online printers: {}, Online printers with owners: {}", 
    //                printerCount, activePrinters.size(), onlinePrintersWithOwners.size());
    //     
    //     if (activePrinters.size() != onlinePrintersWithOwners.size()) {
    //         logger.warn("Found {} online printers without owners: {}", 
    //                     activePrinters.size() - onlinePrintersWithOwners.size(),
    //                     activePrinters.stream()
    //                         .filter(printer -> printer.getOwner() == null)
    //                         .map(printer -> "ID:" + printer.getId() + " Name:" + printer.getName())
    //                         .collect(Collectors.joining(", ")));
    //     }
    //     
    //     // Add attributes to the model - ensure no null values
    //     model.addAttribute("printerCount", printerCount);
    //     model.addAttribute("activePrinters", onlinePrintersWithOwners.size());  // Only count printers with owners
    //     model.addAttribute("printers", onlinePrintersWithOwners != null ? onlinePrintersWithOwners : new ArrayList<>());  // Only show online printers with valid owners
    //     model.addAttribute("locations", locations != null ? locations : new ArrayList<>());
